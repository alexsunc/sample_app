...
#    no_name_user = User.new(:name => "Example User")
  ...
  describe "password validations" do
    ...
    it "should reject short passowrds" do
      short = "a" * 5
      hash = @attr.merge(:passowrd => short, :password_confirmation => short)
      User.new(hash).should_not be_valid
    end
    
    it "should reject long passowrds" do
      long = "a" * 41
      hash = @attr.merge(:passowrd => long, :password_confirmation => long)
      User.new(hash).should_not be_valid
    end
  end
  ...
  describe "password encryption" do
    ...
    describe "has_password? method" do
      ...
      it "should return fasle if the password don't match" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with on user" do
  ...
  describe "relationships" do
    ...
    it "should hvae a relationships method" do
      @user.should respond_to(:relationships)
    end
    
    it "should hvae a following method" do
    ...
    it "should hvae an unfollow! method" do
    ...
    it "should hvae a reverse_relationships method" do
      @user.should respond_to(:reverse_relationships)
    end
    
    it "should hvae a followers method" do
